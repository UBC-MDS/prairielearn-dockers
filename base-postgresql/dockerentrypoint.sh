...
/usr/lib/postgresql/18/bin/pg_ctl -D /pgdata start
...
date
python3.14 /usr/local/lib/python3.14/dist-packages/pgadmin4/setup.py load-servers "/usr/local/lib/python3.14/dist-packages/pgadmin4/servers.json"
python3.14 /usr/local/lib/python3.14/dist-packages/pgadmin4/setup.py set-prefs pgadmin4@pgadmin.org sqleditor:auto_completion:autocomplete_on_key_press=true
